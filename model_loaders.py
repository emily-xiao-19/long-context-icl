...
LONG_LLAMA_WINDOW_SIZE = 32768
OLMO_WINDOW_SIZE = 2048


def validate_model_name(model_name: str) -> None:
    assert 'llama' in model_name.lower() or 'gpt2' in model_name, f"Unknown model: {model_name}"
...
def load_pcw_wrapper(model_name: str, cache_dir: str = None,
    ...
    if 'gpt2' in model_name:
        ...
        context_window_size = LONG_LLAMA_WINDOW_SIZE
    else:
